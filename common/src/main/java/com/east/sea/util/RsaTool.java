...
/**
 * @program: 极度真实还原大麦网高并发实战项目。 添加 tztang 微信，添加时备注 大麦 来获取项目的完整资料
 * @description: rsa工具
 * @author: tztang
 **/
@Slf4j
public class RsaTool {
	...
	public static String decrypt(String data, String privateKeyStr) {
		try {
			...
			throw new BusinessFrameException(BaseCode.RSA_DECRYPT_ERROR);
		}
	}
	...
	public static String encrypt(String data, String publicKey)  {
		try {
			...
			throw new BusinessFrameException(BaseCode.RSA_ENCRYPT_ERROR);
		}
