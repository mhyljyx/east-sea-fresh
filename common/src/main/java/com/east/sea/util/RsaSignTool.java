...
public class RsaSignTool {
    ...
    public static String rsaSign256(String content, String privateKey) {
        try {
            ...
            throw new BusinessFrameException(BaseCode.GENERATE_RSA_SIGN_ERROR);
        }
    }
    ...
    public static boolean verifyRsaSign256(Map<String, String> params, String publicKey){
        try {
            ...
            throw new BusinessFrameException(BaseCode.RSA_SIGN_ERROR);
        }
    }
    ...
    public static void parameterTransferV1() {
        ...
        map.put("sign", sign);
        //验签
        boolean ApiResponse = RsaSignTool.verifyRsaSign256(map, signPublicKey);
        System.out.println("签名结果:" + ApiResponse);
    }
